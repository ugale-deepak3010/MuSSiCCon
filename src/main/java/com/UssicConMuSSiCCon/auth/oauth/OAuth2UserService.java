package com.UssicConMuSSiCCon.auth.oauth;
...
import com.UssicConMuSSiCCon.auth.oauth.user.OAuth2UserInfo;
import com.UssicConMuSSiCCon.auth.oauth.user.OAuth2UserInfoFactory;
import com.UssicConMuSSiCCon.entity.User;
import com.UssicConMuSSiCCon.exception.OAuth2AuthenticationProcessingException;
...
public class OAuth2UserService extends DefaultOAuth2UserService {
    ...
    private OAuth2User processOAuthUser(OAuth2UserRequest oAuth2UserRequest, OAuth2User oAuth2User) {
    	...
    	System.out.println("OAuth2User processOAuthUser");
